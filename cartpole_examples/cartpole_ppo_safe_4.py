...
for epoch in range(epochs):
    ...
    for t in range(steps_per_epoch):
        ...
        distance = np.linalg.norm(np.linalg.norm(observation_new-goal_state)-np.linalg.norm(observation-goal_state))
...
plot.plot_data(episodes,scores,logits_plot,"safe_4_ppo")
