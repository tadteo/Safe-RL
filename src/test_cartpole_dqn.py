...
###############################################################################
    ...
    def train_model(self):
        ...
        # print("Correct shape: ", update_input.shape)
        states = []
        actions = []
        rewards = []
        new_states = []
        ...
        # print("Actual shape ",np_states.shape)
        self.model.fit(np_states, np_targets, batch_size=self.batch_size, epochs=1, verbose=0)
